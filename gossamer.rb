class Gossamer < Formula
    ...
    homepage "https://github.build.ge.com/CloudPod/gossamer"
    url "https://github.build.ge.com/CloudPod/gossamer/releases/download/v1.2.2.56/gossamer-darwin-amd64-1.2.2.56.tar.gz"
